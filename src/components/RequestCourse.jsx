...
const RequestCard = () =>{
  ...
  return(
      <Card maxW='xl' bg='rgba(0, 28, 28, 0.9)' color={'white'} padding={10}>
              <CardBody>
                  <Heading  display={'flex'} justifyContent={'center'} >Request a Course</Heading>
                  <Stack mt='6' spacing='3'>
                      <form>
                          ...
                          <FormLabel mt={'4'} htmlFor='password' children="Course Description" />
                          <Textarea value={message} onChange={(e) =>setMessage(e.target.value)} placeholder='Enter course details' />
